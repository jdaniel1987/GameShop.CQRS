...
namespace GameShop.Application.Read.UnitTests.Queries.GetAllGameConsoles;
...
public sealed class GetAllGameConsolesHandlerTests
{
    ...
    public async Task Handle_ShouldReturnSuccessResult_WhenGameConsolesAreRetrieved(
        [Frozen] Mock<IGameConsoleReadRepository> gameConsolesReadRepositoryMock,
        GetAllGameConsolesQuery query,
        IFixture fixture)
    {
        // Arrange
        var handler = new GetAllGameConsolesHandler(gameConsolesReadRepositoryMock.Object);
        ...
        var gameConsoles = fixture.Build<GameConsole>()
            ...
            .CreateMany()
            .ToImmutableArray();
        gameConsolesReadRepositoryMock
        ...
        // Assert
        gameConsolesReadRepositoryMock.Verify(repo => repo.GetAllGameConsoles(It.IsAny<CancellationToken>()), Times.Once);
